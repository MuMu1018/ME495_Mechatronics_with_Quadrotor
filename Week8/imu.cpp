...
#define KD 220				// 10 to 100	100
#define KI 0.002				// less than 0.05
#define KP_yaw 4.0				// 0 to 15	1.8
#define KI_yaw 0.005				// less than 0.05
        ...
        while(execute==1)
        {
            ...
            */
            ...
            if(execute==1)//if cntrl+c has not been pressed
            {
                ...
                if ((roll_filtered > 40) || (roll_filtered < -40) || (pitch_filtered > 40) || (pitch_filtered < -40) || (diff > 5E8)){
                    ...
                    int prop_PWM0 = neutral_power  + 30 + P_term_roll + KD*roll_velocity + I_term_roll - P_term_yaw - I_term_yaw;
                    int prop_PWM1 = neutral_power  - P_term_roll - KD*roll_velocity - I_term_roll - P_term_yaw - I_term_yaw;
                    
                    //int prop_PWM0 = 1000;
                    //int prop_PWM1 = 1000;
                    int prop_PWM2 = neutral_power - P_term_pitch - KD*pitch_velocity - I_term_pitch + P_term_yaw + I_term_yaw;
                    int prop_PWM3 = neutral_power + P_term_pitch + KD*pitch_velocity + I_term_pitch + P_term_yaw + I_term_yaw;
